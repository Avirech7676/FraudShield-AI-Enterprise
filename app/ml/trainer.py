...
class EnterpriseFraudTrainer:
    ...
    def save_best_model(self):
        ...
        try:
            ...
            joblib.dump(self.best_model, settings.PRODUCTION_MODEL,compress=3)
            ...
            logger.info(f"Saved production model -> {settings.PRODUCTION_MODEL}")
            ...
            if (
                self.best_auc >= 0.95
                and self.registry.compare(self.best_auc)
            ):
    ...
    def save_training_log(self):
        try:
            ...
            log = {
                ...
                "f1": self.best_f1,
                "roc_auc": self.best_auc,
                "training_time_seconds": round(duration.total_seconds(),2)
            }
            ...
            metadata = {
                ...
                "model_path": str(settings.PRODUCTION_MODEL),
